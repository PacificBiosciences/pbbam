...
extern const ChemistryTable BuiltInChemistryTable = {
    ...
    // 5.0.1 ChemRel; Sequel® Binding Kit 3.0; S/P2-C2
    {{"101-500-400", "101-427-500", "5.0", "S/P2-C2/5.0"}}, // Sequel® Sequencing Plate 3.0 (8 rxn)
    {{"101-500-400", "101-427-800", "5.0", "S/P2-C2/5.0"}}, // Sequel® Sequencing Plate 3.0 (4 rxn)
