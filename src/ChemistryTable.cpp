...
const ChemistryTable& BuiltInChemistryTable()
{
    ...
    static ChemistryTable builtin{
        ...
        {{"101-490-800", "101-490-900", "5.0", "S2/P3-C1/5.0"}}, // Sequel II® Sequencing Plate (4 rxn)
        {{"101-490-800", "101-491-000", "5.0", "S2/P3-C1/5.0"}}, // Sequel II® Sequencing Plate (8 rxn)
        ...
        {{"101-490-800", "101-644-500", "5.0", "S2/P3-C1/5.0"}} // Sequel® Dev Sequencing Plate Dyn Loading
    };
    // clang-format on
