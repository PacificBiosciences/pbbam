...
const BamRecordTags::TagLookupType BamRecordTags::tagLookup =
{
    ...
    { BamRecordTag::SEGMENT_ADAPTER_LEFT,     {"dl", false} },
    { BamRecordTag::SEGMENT_ADAPTER_RIGHT,    {"dr", false} },
    { BamRecordTag::SEGMENT_INDEX,            {"di", false} },
    { BamRecordTag::SEGMENT_SUPPLEMENTAL,     {"ds", false} },
