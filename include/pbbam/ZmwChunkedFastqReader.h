#ifndef PBBAM_ZMWCHUNKEDFASTQREADER_H
#define PBBAM_ZMWCHUNKEDFASTQREADER_H
...
public:
    ...
    /// size is smaller.
    ///
    ZmwChunkedFastqReader(const std::string& fn, std::size_t numChunks);
    ...
    ///
    ZmwChunkedFastqReader& Chunk(std::size_t chunkId);
...
#endif  // PBBAM_ZMWCHUNKEDFASTQREADER_H
