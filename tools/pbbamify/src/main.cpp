...
int main(int argc, char* argv[])
{
    ...
    parser.description("pbbamify converts an arbitray aligned BAM file to a PacBio-compatible BAM file."
    ...
    optionGroup.add_option("")
               .dest("ref")
               .help("Reference used to align the input.");
    optionGroup.add_option("--input")
               .dest("input")
               .metavar("STR")
               .help("The aligned non-PacBio BAM file. If not provided, stdin will be used as input.");
    ...
    optionGroup.add_option("--verbose-level")
               ...
               .metavar("INT")
               .set_default("3")
               .help("Specifies the level of info which will be output produced on"
    ...
    optionGroup.add_option("")
               .dest("pbbam")
               .help("A PacBio BAM file containing raw reads.");
    ...
    const PacBio::BAM::pbbamify::Settings settings = PacBio::BAM::pbbamify::Settings::FromCommandLine(parser, argc, argv);
    ...
    try {
        ...
        {   // A block is used here to close the bamWriter and the reference reader.
            ...
            bool augment_rv = PacBio::BAM::pbbamify::Pbbamify::AugmentAlignments(
                                                                newHeader, queryLookup, indexedRefReader,
                                                                inputBamReader, bamWriter, settings.verboseLevel_);
            if (augment_rv == false) {
                return EXIT_FAILURE;
            }
        }
