...
TEST(BAM_ReadGroupInfo, can_read_write_optional_description_fields) 
{
    const std::string input{
        ...
        "RUNID=r84029_20230127_224717;BASECALLERVERSION=5.0;ICSVERSION=12.0.0.172107;MOVIELENGTH=15.0;"
    ...
    EXPECT_NE(output.find("MOVIELENGTH=15.0"), std::string::npos);
}
