...
TEST(BAM_FastqSequence, BasicConstructorsOk)
{
    ...
    const std::vector<std::uint8_t> quals{58, 58, 58, 58, 58, 58, 58};
    const FastqSequence seq2{"1", "GATTACA", Data::QualityValues{quals}};
